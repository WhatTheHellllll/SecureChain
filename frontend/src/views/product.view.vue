...
<template>
  <div class="p-6">
    ...
    <div class="flex justify-between items-center mb-6">
      ...
      <RouterLink to="/products/create" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg font-medium transition shadow-sm">
        + Add Product
      </RouterLink>
    </div>
        ...
        <table class="min-w-full divide-y divide-gray-200">
          ...
          <tbody class="bg-white divide-y divide-gray-200">
            <tr v-for="product in filteredProducts" :key="product._id" class="hover:bg-gray-50 transition">
              ...
              <td class="px-6 py-4 whitespace-nowrap">
                <span :class="product.quantity < 5 ? 'text-red-600 font-bold' : 'text-gray-900'">
                  {{ product.quantity }}
                </span>
              </td>
